...
public class PlatinumAdvancements implements Consumer<Consumer<Advancement>> {
    ...
    public void accept(Consumer<Advancement> advancementConsumer) {
        Advancement root = Advancement.Builder.advancement().display(ModItems.PLATINUM_INGOT.get(), new TranslatableComponent("advancements.platinum.root.title"), new TranslatableComponent("advancements.platinum.root.description"), (ResourceLocation) null, FrameType.GOAL, true, true, false).rewards(AdvancementRewards.Builder.experience(100)).addCriterion("platinum_ingot", InventoryChangeTrigger.TriggerInstance.hasItems(ModItems.PLATINUM_INGOT.get())).save(advancementConsumer, modId("platinum/root").toString());
